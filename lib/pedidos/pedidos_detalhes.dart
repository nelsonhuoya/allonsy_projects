...
class PedidosDetalhes extends StatelessWidget {
  ...
  PedidosDetalhes({this.id, this.data, this.retirada, this.endereco, this.complemento});
                        ...
                        Container(
                          child: Column(
                            children: [
                              Container(
                                child: Padding(
                                  padding: EdgeInsets.only(left: 8.h, top: 15.h, bottom: 10.h),
                                  child: Container(
                                    child: Column(
                                      children: [
                                        Row(
